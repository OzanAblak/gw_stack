...
pid=''
if h==200:
    txt=post(base+'/v1/plan/compile',b'{}')
    try: pid=json.loads(txt).get('planId','')
    except: pid=''
g=-1
if pid:
    end=time.time()+10
...
print('PL_PORT=9090'); print(f'PL_HEALTH={h}'); print(f'PLANID={pid}'); print(f'PL_GET={g}'); print(f'SUMMARY={summary}')
